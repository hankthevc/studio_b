const appConfig = {
  ...
  plan: {
    derive: ({ values }) => {
      const breathByMood = {
        wired: "6 cycles of 4-7-8",
        meh: "4 cycles box breathing",
        calm: "3 cycles gentle inhale/exhale"
      };
      const soundByRoom = {
        bedroom: "Soft rain",
        living: "Gentle lo-fi",
      ...
      return {
        breath: breathByMood[values.eveningFeel] || "4 breath cycles",
        sound: soundByRoom[values.room] || "Soft rain"
      };
    },
    summary: {
