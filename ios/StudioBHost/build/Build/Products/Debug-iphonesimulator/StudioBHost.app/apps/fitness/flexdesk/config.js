const appConfig = {
  ...
  plan: {
    derive: ({ values }) => {
      const movesByTension = {
        neck: "Neck CARs, upper trap stretch",
        back: "Seated cat/cow, thoracic rotations",
        hips: "Seated figure-4, hip flexor lunge"
      };
      const energyCues = {
        sleepy: "Keep breaths slow; avoid aggressive holds.",
        stiff: "Mix mobility with light activation.",
        energized: "Add a few chair squats or desk pushups."
      };
      return {
        moveSet: movesByTension[values.tension] || "Desk-friendly mobility set",
        energyCue: energyCues[values.energy] || "Breathe steady; move smoothly"
      };
    },
    summary: {
