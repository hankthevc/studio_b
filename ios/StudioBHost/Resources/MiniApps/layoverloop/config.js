const appConfig = {
  ...
  plan: {
    derive: ({ values }) => {
      ...
      const vibeStops = {
        recharge: ["Quiet lounge", "Calm cafe", "Water refill"],
        explore: ["Iconic landmark", "Side street snap", "Local market"],
        foodie: ["Local cafe", "Street food bite", "Dessert stop"]
      };
    ...
    summary: {
      ...
      metrics: [
        {
          label: "Stops",
          value: "{{derived.stops.0}}, {{derived.stops.1}}, {{derived.stops.2}}"
        },
        {
          label: "Return buffer",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Follow a three-stop path: {{derived.stops.0}}, {{derived.stops.1}}, {{derived.stops.2}}.",
